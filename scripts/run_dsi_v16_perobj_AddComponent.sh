...
#SBATCH --output=/net/scratch/caom/repo_project/logs/v16_AddComponent_only_%j.out
#SBATCH --error=/net/scratch/caom/repo_project/logs/v16_AddComponent_only_%j.err

# ==============================================
# Per-objective: AddComponent-only active-GRPO (v16 full)
...
OUTPUT_DIR=${SCRATCH}/outputs/ada_repo_dsi_v16_AddComponent_only
PRED_DIR=${SCRATCH}/outputs/eval_v16_AddComponent_only/predictions/
...
echo "=============================================="
echo "Per-objective: AddComponent-only active-GRPO (v16)"
...
ACCELERATE_LOG_LEVEL=info accelerate launch \
    ...
    --num_processes 2 \
    ${ADA_DIR}/ada_repo.py \
    --config ${ADA_DIR}/configs/DSI_v16_AddComponent_only.yaml \
    --output_dir ${OUTPUT_DIR} \
    --variant default \
    --run_name "adarepo_v16_AddComponent_only"
...
echo "--- Evaluating AddComponent with model ${MODEL_PATH} ---"
