...
#SBATCH --mem=0
#SBATCH --output=/net/scratch/caom/repo_project/logs/v15_1_retrain_eval_%j.out
#SBATCH --error=/net/scratch/caom/repo_project/logs/v15_1_retrain_eval_%j.err

# ==============================================
# Eval v15.1 retrain checkpoint-748 (full 4 epochs)
...
FINAL_MODEL=${SCRATCH}/outputs/ada_repo_dsi_v15_1_retrain/checkpoint-748
PRED_DIR=${SCRATCH}/outputs/eval_v15_1_retrain/predictions/

echo "=============================================="
echo "v15.1 Retrain Eval — checkpoint-748 (epoch 4.0)"
