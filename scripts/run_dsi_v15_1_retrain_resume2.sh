...
# ==============================================
# Resume v15.1 retrain from checkpoint-650
# Remaining: ~98 steps (~1.8h), 4h walltime buffer
# ==============================================
...
CKPT=${OUTPUT_DIR}/checkpoint-650

echo "=============================================="
echo "v15.1 Resume from checkpoint-650 (~98 steps left)"
