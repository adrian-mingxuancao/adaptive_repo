...
#SBATCH --output=/net/scratch/caom/repo_project/logs/v17_%j.out
#SBATCH --error=/net/scratch/caom/repo_project/logs/v17_%j.err

# ==============================================
# AdaRePO v17 — Per-Sample Beta Guidance (Bug Fix)
#
# Fixes:
#   Bug #1: beta_guide averaged to scalar → now per-sample
#   Bug #2: s_loss batch-averaged before weighting → now per-sample
#
# Same dataset/hyperparams as v16 for fair comparison.
# Expected: ~12h for 4 epochs (748 steps).
# ==============================================
...
echo "=============================================="
echo "AdaRePO v17 — Per-Sample Beta Guidance"
...
ACCELERATE_LOG_LEVEL=info accelerate launch \
    ...
    --variant default \
    --run_name "adarepo_v17_per_sample_beta"
