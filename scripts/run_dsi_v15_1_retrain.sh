...
# ==============================================
# AdaRePO v15.1 Boosted — FULL retrain from scratch
# Fixed CleanOptimizerStatesCallback (keeps latest ckpt resumable)
# If time-limited, can resume from latest checkpoint
# ==============================================
...
echo "=============================================="
echo "AdaRePO v15.1 Retrain — Joint LogP+MR+QED"
