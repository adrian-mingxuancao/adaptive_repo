...
#SBATCH --output=/net/scratch/caom/repo_project/logs/v16_%j.out
#SBATCH --error=/net/scratch/caom/repo_project/logs/v16_%j.err

# ==============================================
# AdaRePO v16 — Adaptive Curriculum + Self-Distillation
# Features: adaptive temperature + memory bank
# 4 epochs, ~748 steps, ~14h at 67s/step (may need resume)
# ==============================================
...
echo "=============================================="
echo "AdaRePO v16 — Adaptive Curriculum + Self-Distillation"
