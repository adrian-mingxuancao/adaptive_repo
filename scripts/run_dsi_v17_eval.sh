...
#SBATCH --output=/net/scratch/caom/repo_project/logs/v17_eval_%j.out
#SBATCH --error=/net/scratch/caom/repo_project/logs/v17_eval_%j.err

# ==============================================
# Eval v17 checkpoint-748 (per-sample beta fix)
...
FINAL_MODEL=${SCRATCH}/outputs/ada_repo_dsi_v17/checkpoint-748
PRED_DIR=${SCRATCH}/outputs/eval_v17/predictions/

echo "=============================================="
echo "v17 Eval — checkpoint-748 (per-sample beta fix)"
