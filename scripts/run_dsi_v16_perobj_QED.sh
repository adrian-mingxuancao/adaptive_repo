...
#SBATCH --output=/net/scratch/caom/repo_project/logs/v16_QED_only_%j.out
#SBATCH --error=/net/scratch/caom/repo_project/logs/v16_QED_only_%j.err

# ==============================================
# Per-objective: QED-only active-GRPO (v16 full)
...
OUTPUT_DIR=${SCRATCH}/outputs/ada_repo_dsi_v16_QED_only
PRED_DIR=${SCRATCH}/outputs/eval_v16_QED_only/predictions/
...
echo "=============================================="
echo "Per-objective: QED-only active-GRPO (v16)"
...
ACCELERATE_LOG_LEVEL=info accelerate launch \
    ...
    --num_processes 2 \
    ${ADA_DIR}/ada_repo.py \
    --config ${ADA_DIR}/configs/DSI_v16_QED_only.yaml \
    --output_dir ${OUTPUT_DIR} \
    --variant default \
    --run_name "adarepo_v16_QED_only"

echo "=== Training complete at $(date) ==="

# === EVAL ===
# Find model (save_strategy=no saves at top-level)
...
echo "--- Evaluating QED with model ${MODEL_PATH} ---"
